static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEWSTEM_TOWN - 1] = {MAP_GROUP(NEWSTEM_TOWN), MAP_NUM(NEWSTEM_TOWN), 20, 11},
    [HEAL_LOCATION_SPRINGWOOD_CITY - 1] = {MAP_GROUP(SPRINGWOOD_CITY), MAP_NUM(SPRINGWOOD_CITY), 26, 31},
    [HEAL_LOCATION_OCHRE_VALE - 1] = {MAP_GROUP(OCHRE_VALE), MAP_NUM(OCHRE_VALE), 18, 6},
    [HEAL_LOCATION_DYECRESS_TOWN - 1] = {MAP_GROUP(DYECRESS_TOWN), MAP_NUM(DYECRESS_TOWN), 24, 28},
};
