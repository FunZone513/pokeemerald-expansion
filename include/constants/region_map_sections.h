...
// my stuff here
#define MAPSEC_NEWSTEM_TOWN                 MAPSEC_LITTLEROOT_TOWN
#define MAPSEC_SPRINGWOOD_CITY              MAPSEC_RUSTBORO_CITY
#define MAPSEC_QUIET_GROVE                  MAPSEC_PETALBURG_WOODS
#define MAPSEC_DRIPSTONE_CAVE               MAPSEC_METEOR_FALLS
