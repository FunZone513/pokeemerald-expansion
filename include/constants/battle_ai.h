...
#define AI_FLAG_GYM_LEADER            (AI_FLAG_SMART_TRAINER | AI_FLAG_ACE_POKEMON | AI_FLAG_POWERFUL_STATUS | AI_FLAG_HP_AWARE)
#define AI_FLAG_PREDICTION            (AI_FLAG_PREDICT_SWITCH | AI_FLAG_PREDICT_INCOMING_MON)
#define AI_FLAG_CHEESE_TRAINER        (AI_FLAG_BASIC_TRAINER | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_WILL_SUICIDE | AI_FLAG_HP_AWARE)
